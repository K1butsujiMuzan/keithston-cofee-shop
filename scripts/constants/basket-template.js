  ...
  return `
    <li class="basket-modal__list-item">
      <img
        ...
        loading="lazy"
      />
      <span class="basket-modal__title">${title}</span>
      <span class="basket-modal__price">$${price}</span>
      <button
        class="basket-modal__remove"
        type="button"
...
export const basketEmpty = `
  <li class="basket-modal__empty">The cart is empty :(</li>
`